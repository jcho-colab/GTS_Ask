  ...
  const TableRow = ({ user }) => (
    <tr className='border-b border-gray-200 text-gray-600 hover:bg-gray-400/10'>
      ...
      <td className='p-2 flex gap-4 justify-end'>
        <Button
          className='text-amber-600 hover:text-amber-500 font-semibold sm:px-0'
          label='Edit'
          type='button'
      ...
      <div className='w-full md:px-1 px-0 mb-6'>
        <div className='flex items-center justify-between mb-8'>
          ...
          <Button
            ...
            className='flex flex-row-reverse gap-1 items-center bg-black hover:bg-amber-500 text-white rounded-md 2xl:py-2.5 transition-colors'
